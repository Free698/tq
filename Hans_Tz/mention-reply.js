    ...
    if (m.mentionedJid.includes(botNumber)) {
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "VORTEX-XMD 🥀",
            body: config.DESCRIPTION || "POWERED BY VORTEX-XMD 🤌💗",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://files.catbox.moe/di5kdx.jpg", // Static image URL
            sourceUrl: "https://wa.me/255658407824",
